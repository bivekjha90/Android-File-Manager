...
public class HelpManager extends Activity implements OnClickListener {
	private static final String[] EMAIL = {"biveknitdca@gmail.com"};
	private static final String WEB = "http://bivek.webs.com";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String text = "Open Manager: If you have any questions or "
						+"comments, please email me(biveknitdca@gmail.com)  or visit "
						+"the my  web page.\n\nThank you\n\n";
